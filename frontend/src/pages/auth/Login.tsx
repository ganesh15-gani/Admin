        ...
        <div className="p-8 sm:p-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight text-center">
              StayZen<span className="text-brand-600">.</span>
            </h1>
            <p className="text-sm text-slate-500 mt-2 text-center">
              Sign in to the premium admin dashboard
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="animate-slide-up" style={{ animationDelay: '300ms' }}>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <a href="#" className="text-xs font-medium text-brand-600 hover:text-brand-500 transition-colors">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center animate-slide-up" style={{ animationDelay: '400ms' }}>
              <input
                id="remember-me"
                type="checkbox"
                className="h-4 w-4 text-brand-600 focus:ring-brand-500 border-gray-300 rounded cursor-pointer transition-colors"
              />
            ...
            <div className="pt-2 animate-slide-up" style={{ animationDelay: '500ms' }}>
              <Button 
                type="submit" 
                variant="primary" 
            ...
            <div className="text-center mt-6 animate-slide-up" style={{ animationDelay: '600ms' }}>
